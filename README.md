...
```bash
conda create -n cicd_sample_project python=3.9
conda activate cicd_sample_project
```
...
```
This command will create your personal repository under `/Repos/<username>/cicd_sample_project`.
